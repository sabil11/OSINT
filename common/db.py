...
class MongoDBConnection(object):
    ...
    def __init__(self, db_name='osint', collection_name='raw', host='localhost', port=27017):
        self.host = host
        self.port = port
        self.client = None
    ...
    def append(self, source, term, run_date, data):
        resp = {
            "source": source,
            "resp": data,
            "last_modified": datetime.datetime.now()
        }
        find = {'input': term, 'run_date': run_date, 'source': source}
